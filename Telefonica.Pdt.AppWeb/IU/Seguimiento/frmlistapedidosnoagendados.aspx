<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmlistapedidosnoagendados.aspx.vb" Inherits="Telefonica.Pdt.AppWeb.frmlistapedidosnoagendados" %>
                                ...
                                <table style="width: 100%" cellspacing="0" cellpadding="0" align="left" border="0">
                                    <tr style="height: 30px" align="center" class="TablaFilaTitulo">
                                        <td style="height: 30px">
                                            <asp:Label ID="lblTitulo" CssClass="TituloPrincipal" runat="server">PEDIDOS PENDIENTES DE AGENDAMIENTO</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td valign="top">
                                            <table id="tFiltroAvanzado" cellspacing="1" cellpadding="1" width="100%" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="TablaFilaPar" width="29%">
                                                        <asp:DropDownList ID="ddlbProveedor" runat="server" CssClass="InputTexto" Width="85%" CausesValidation="True">
                                                        </asp:DropDownList>
                                                                                ...
                                                                                <tr>
                                                                                    <td rowspan="2" valign="top" style="width: 50%">
                                                                                        <asp:DataGrid ID="grid" runat="server" Width="100%" AutoGenerateColumns="False" HorizontalAlign="Center"
                                                                                            AllowPaging="True" PageSize="7" ShowFooter="True">
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:BoundColumn HeaderText="PEDIDO INVALIDO" DataField="PedidoInvalido">
                                                                                                    <ItemStyle Width="15%" HorizontalAlign="Center" />
                                                                                                    <HeaderStyle Width="15%" />
                                                                                                </asp:BoundColumn>
                                                                                            </Columns>
                                                                ...
                                                                <asp:DataGrid ID="gridc" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn HeaderText="ZONA" DataField="zgrpc_vDescripcion">
                                                                            <ItemStyle Width="40%" Height="15px" HorizontalAlign="Left" />
                                                                            <HeaderStyle Width="40%" Height="15px" HorizontalAlign="Center" />
                                                                        </asp:BoundColumn>
                                                                        ...
                                                                        <td align="right">
                                                                            <asp:DataGrid ID="gridd" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundColumn HeaderText="RESERVAS">
                                                                                        <HeaderStyle Width="10%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="RESERVAS NO EMITIDAS">
                                                                                        <HeaderStyle Width="15%" />
                                                                                    </asp:BoundColumn>
                                                                                </Columns>
                                                                            </asp:DataGrid>
                                                                            <input id="hCodigoCupo" style="width: 2px; height: 2px" type="hidden" name="hCodigoCupo"
                                                                                runat="server">
                                                                            <asp:Button ID="btnAgregar" runat="server" CssClass="InputBoton" Text="Agregar" Width="60px" Visible="False"  /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Panel ID="pnlDetalleCupo" Visible=false runat="server" Width="100%">
                                                                                <table style="width: 100%" cellspacing="1" cellpadding="1" align="left" border="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width: 70%" class="TablaFilaPar">
                                                                                            <ew:NumericBox ID="nbCupos" runat="server" CssClass="InputTexto" Width="20%"
                                                                                                PositiveNumber="True" RealNumber="False"></ew:NumericBox></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="width: 30%" align="right" class="TablaColumnaEtiqueta">
                                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" class="TablaColumnaEtiqueta" colspan="2">
                                                                                            ...
                                                                                            <asp:Button ID="btnCancelar" runat="server" CssClass="InputBoton" Text="Cancelar" Width="60px"  /></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </asp:Panel>
                                                                        </td>
