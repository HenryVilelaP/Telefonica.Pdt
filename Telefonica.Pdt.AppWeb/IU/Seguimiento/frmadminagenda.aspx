<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmadminagenda.aspx.vb"
    Inherits="Telefonica.Pdt.AppWeb.frmadminagenda" %>
                                    ...
                                    <tr valign="top">
                                        <td>
                                            <table style="width: 100%" cellspacing="1" cellpadding="1" align="left" border="0">
                                                <tr>
                                                    <td rowspan="1" style="width: 50%" valign="top">
                                                                                        ...
                                                                                        <asp:DataGrid ID="grid" runat="server" Width="100%" AutoGenerateColumns="False" HorizontalAlign="Center"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateColumn HeaderText="FECHA">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:LinkButton ID="lbkbFecha" runat="server"></asp:LinkButton>
                                                                                                    </ItemTemplate>
                                                                                                    <HeaderStyle Width="40%" />
                                                                                                    <ItemStyle Width="40%" HorizontalAlign="Left" />
                                                                                                </asp:TemplateColumn>
                                                                                                <asp:BoundColumn HeaderText="DIA" DataField="NombreDia">
                                                                                                ...
                                                                                                <asp:BoundColumn HeaderText="NO EMITIDOS" DataField="NoEmitidos">
                                                                                                    <ItemStyle Width="15%" HorizontalAlign="Center" />
                                                                                                    <HeaderStyle Width="15%" />
                                                                                                </asp:BoundColumn>
                                                                                                <asp:BoundColumn HeaderText="PED. INVAL." DataField="PedidoInvalido">
                                                                                                    <ItemStyle Width="15%" HorizontalAlign="Center" />
                                                                                                    <HeaderStyle Width="15%" />
                                                                                                </asp:BoundColumn>
                                                                                            </Columns>
                                                                        ...
                                                                        <ContentTemplate>
                                                                            <asp:DataGrid ID="gridc" runat="server" Width="100%" AutoGenerateColumns="False"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateColumn HeaderText="CERRAR FECHA">
                                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                                                                                <tr>
                                                                                    <td align="right">
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateColumn HeaderText="CUPOS">
                                                                                                    ...
                                                                                                    <ItemTemplate>
                                                                                                        ...
                                                                                                        <asp:LinkButton ID="lnkbCupos" runat="server"></asp:LinkButton>&nbsp;
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateColumn>
                                                                                                <asp:BoundColumn HeaderText="RESERVAS" DataField="Reserva">
                                                                                                    <HeaderStyle Width="10%" />
                                                                                                </asp:BoundColumn>
                                                                                                <asp:BoundColumn HeaderText="RES. NO EMITIDAS" DataField="ReservaNoEmitida">
                                                                                                    <HeaderStyle Width="20%" />
                                                                                                </asp:BoundColumn>
                                                                                            </Columns>
                                                                                        </asp:DataGrid>
                                                                                        <input id="hCodigoCupo" style="width: 2px; height: 2px" type="hidden" name="hCodigoCupo"
                                                                                            runat="server">
                                                                                        <asp:Button ID="btnAgregar" runat="server" CssClass="InputBoton" Text="Agregar" Width="60px"
                                                                                            Visible="False" /></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:Panel ID="pnlDetalleCupo" Visible="false" runat="server" Width="100%">
                                                                                            <table style="width: 100%" cellspacing="1" cellpadding="1" align="left" border="0">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="width: 70%" class="TablaFilaPar">
                                                                                                        <asp:DropDownList ID="ddlbFranja" runat="server" CssClass="InputTexto" Width="30%">
                                                                                                        </asp:DropDownList></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 30%" align="right" class="TablaColumnaEtiqueta">
                                                                                                    ...
                                                                                                    <td style="width: 70%" class="TablaFilaPar">
                                                                                                        <ew:NumericBox ID="nbCupos" runat="server" CssClass="InputTexto" Width="20%" PositiveNumber="True"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" class="TablaColumnaEtiqueta" colspan="2">
                                                                                                        <asp:Button ID="btnGrabar" runat="Server" CssClass="InputBoton" Text="Grabar" Width="60px" />
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:DataGrid ID="gride" runat="server" Width="100%" HorizontalAlign="Center" AutoGenerateColumns="False">
                                                                                            <FooterStyle CssClass="FooterGrilla"></FooterStyle>
                                                                                            <PagerStyle Mode="NumericPages" CssClass="PagerGrilla" HorizontalAlign="Center"></PagerStyle>
                                                                                            <AlternatingItemStyle CssClass="AlternateItemGrilla"></AlternatingItemStyle>
                                                                                            <ItemStyle Height="20px" CssClass="ItemGrilla" HorizontalAlign="Center" VerticalAlign="Top">
                                                                                            </ItemStyle>
                                                                                            <HeaderStyle Height="20px" CssClass="HeaderGrilla" HorizontalAlign="Center" VerticalAlign="Top">
                                                                                            </HeaderStyle>
                                                                                            <Columns>
                                                                                                <asp:BoundColumn HeaderText="N&#186;">
                                                                                                ...
                                                                                                <asp:BoundColumn HeaderText="PRODUCTO">
                                                                                                    <HeaderStyle Width="14%" />
                                                                                                </asp:BoundColumn>
                                                                                                <asp:BoundColumn HeaderText="OC">
                                                                                                    <HeaderStyle Width="14%" />
                                                                                                </asp:BoundColumn>
                                                                                                <asp:BoundColumn HeaderText="N&#186; PEDIDO">
                                                                                                    <HeaderStyle Width="14%" />
                                                                                                </asp:BoundColumn>
                                                                                                <asp:BoundColumn DataField="Franja" HeaderText="FRANJA">
                                                                                                    <ItemStyle Width="15%" HorizontalAlign="Left"></ItemStyle>
                                                                                                    <HeaderStyle Width="14%"></HeaderStyle>
                                                                                                </asp:BoundColumn>
                                                                                                <asp:BoundColumn HeaderText="CLIENTE">
                                                                                                    <HeaderStyle Width="14%" />
                                                                                                </asp:BoundColumn>
                                                                                                <asp:BoundColumn HeaderText="CONTACTO">
                                                                                                    <HeaderStyle Width="14%" />
                                                                                                </asp:BoundColumn>
                                                                                                <asp:BoundColumn HeaderText="TELEFONO CONT.">
                                                                                                    <HeaderStyle Width="14%" />
                                                                                                </asp:BoundColumn>
                                                                                            </Columns>
                                                                                        </asp:DataGrid>
