...
#End Region
        ...
        Protected Sub gridc_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles gridc.ItemDataBound
            If ((e.Item.ItemType = ListItemType.AlternatingItem) OrElse (e.Item.ItemType = ListItemType.Item)) Then
                ...
                ElseIf Convert.ToString(dr("FechaCerrada".ToString())) > 0 And _
                    ...
                    lnkbCerrarFecha.Visible = True
                End If
                Dim zgrpc_iIdZona_Grp_Instalacion As Integer = Convert.ToInt32(dr(Enumeradores.col_PDTT_GRP_INSTALACION.zgrpc_iIdZona_Grp_Instalacion.ToString()))
                Dim Cadena As String = HelperWeb.AsignarDatoControlHtml(Me.hCodigoCierre.ID, zgrpc_iIdZona_Grp_Instalacion.ToString())
                HelperWeb.SeleccionarItemGrillaOnClickMoverRaton(e, Cadena)
            End If
        End Sub
        ...
        Protected Sub btnAgregar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
            Me.pnlDetalleCupo.Visible = True
            Me.btnAgregar.Visible = False
            Me.hCodigoCupo.Value = ConstantesWeb.VACIO
