...
Namespace Telefonica.Pdt.AppWeb
    ...
    Partial Class frmagendaproveedor
...
#Region "Metodos Formulario"
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            Try
                Me.ddlbProveedor.Enabled = False
                Me.ddlbProveedor.SelectedValue = 1
        ...
        Private Sub grid_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles grid.ItemDataBound
            If ((e.Item.ItemType = ListItemType.AlternatingItem) OrElse (e.Item.ItemType = ListItemType.Item)) Then
                ...
                lbkbFecha.CssClass = "ItemGrillaLink"
...
#End Region
        ...
        Protected Sub gridd_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles gridd.ItemDataBound
            If ((e.Item.ItemType = ListItemType.AlternatingItem) OrElse (e.Item.ItemType = ListItemType.Item)) Then
                ...
                Dim Js As String = "CambiarColorSeleccion(); "
                Js += HelperWeb.AsignarDatoControlHtml(Me.hCodigoCupo.ClientID, cupoc_iIdCupo.ToString())
