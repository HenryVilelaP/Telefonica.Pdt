<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmOpcionAccion.aspx.vb" Inherits="Telefonica.Pdt.AppWeb.IU_seguridad_frmOpcionAccion" %>
                                            ...
                                            <table id="tContenido" cellspacing="1" cellpadding="1" width="100%" align="center"
                                                        ...
                                                        <table style="width: 100%">
                                                            <tr class="TablaFilaTitulo">
                                                                <td colspan="5" style="height: 30px" valign="middle">
                                                                    <asp:Label ID="Label5" runat="server" CssClass="TituloPrincipal" Width="180px">OPCION - ACCIONES</asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="5">
                                                                </td>
                                                            ...
                                                            <ContentTemplate>
                                                                ...
                                                                <asp:GridView ID="grid" runat="server" Width="100%" CssClass="AlternateItemGrilla" OnPageIndexChanging="grid_PageIndexChanging" OnRowDataBound="grid_RowDataBound" AutoGenerateColumns="False">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="accic_vDescripcion" HeaderText="ACCION" >
                                                                            <ItemStyle HorizontalAlign="Left" />
                                                                        </asp:BoundField>
                                                                        <asp:BoundField DataField="oaccc_iEstado_Registro" HeaderText="ESTADO"  Visible="False"/>
                                                                    </Columns>
                                                                </asp:GridView>
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <tr>
                                                    <td align="center" style="height: 21px">
                                                        <asp:Button ID="btnGrabar" runat="server" Text="Grabar" CssClass="InputBoton" Width="90px"></asp:Button>
                                                        <asp:Button ID="btnRegresar" runat="server" CausesValidation="False" CssClass="InputBoton"
                                                            Text="Regresar" Width="90px" /></td>
                                                </tr>
                                                <tr>
