<%@ Page Language="vb" AutoEventWireup="false" CodeFile="Areausuario.aspx.vb" Inherits="Areausuario"%>
												                    ...
												                    <TABLE id="tblFormUsuarios" cellSpacing="1" cellPadding="1" width="300" border="1">
													                    <TR>
														                    <TD align="center" colSpan="2" style="height: 23px">
															                    <asp:Label id="Label5" runat="server" CssClass="normalDetalle" Width="138px">AREAS POR USUARIO</asp:Label></TD>
													                    </TR>
													                    <TR>
													                    ...
													                    <TR>
														                    <TD align="center" colSpan="2">
															                    ...
															                    <asp:Button id="Button2" runat="server" Text="Limpiar" CssClass="boton"></asp:Button></TD>
													                    </TR>
												                    </TABLE>
											                    </td>
										                    </tr>
												                    ...
												                    <TABLE id="Table2" cellSpacing="1" cellPadding="1" width="300" border="1">
													                    <TR>
														                    <TD align="center" colSpan="1">
															                    <asp:Label id="Label10" runat="server" CssClass="normalDetalle">Areas:</asp:Label></TD>
													                    </TR>
													                    <TR>
