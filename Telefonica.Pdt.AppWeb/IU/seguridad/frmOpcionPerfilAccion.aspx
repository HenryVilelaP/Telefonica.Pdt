<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmOpcionPerfilAccion.aspx.vb" Inherits="Telefonica.Pdt.AppWeb.IU_seguridad_frmOpcionPerfilAccion" %>
...
<head runat="server">
    <title>PDT PERFIL/OPCION/ACCION</title>
                                            ...
                                            <table id="tContenido" cellspacing="1" cellpadding="1" width="100%" align="center"
                                                    ...
                                                    <td align="center">
                                                        <table style="width: 100%">
                                                            <tr class="TablaFilaTitulo">
                                                                <td colspan="5" style="height: 32px" valign="middle">
                                                                    <asp:Label ID="Label5" runat="server" CssClass="TituloPrincipal" Width="213px">OPCION - PERFIL - ACCION</asp:Label></td>
                                                            </tr>
                                                                   ...
                                                                   <table style="width: 635px">
                                                                        <tr>
                                                                            <td style="width: 187px">
                                                                                <asp:Label ID="Label1" runat="server" CssClass="normaldetalle" Width="184px">PERFIL / OPCION SELECCIONADA:</asp:Label></td>
                                                                            <td align="left">
                                                                                <asp:Label ID="lblPerfilOpcionSelecionada" runat="server" CssClass="normaldetalle"
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanelGrilla" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <table style="width: 100%">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                <asp:GridView ID="grid" runat="server" Width="100%" CssClass="AlternateItemGrilla" OnPageIndexChanging="grid_PageIndexChanging" OnRowDataBound="grid_RowDataBound" AutoGenerateColumns="False">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="APLICAR">
                                                                            <ItemTemplate>
                                                                                <asp:CheckBox ID="chkIdAccion" runat="server" CssClass="InputTexto" />
                                                                                <asp:HiddenField ID="hIdAccion" runat="server" />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>                                                                        
                                                                        <asp:BoundField DataField="accic_vDescripcion" HeaderText="OPCION" >
                                                                            <ItemStyle HorizontalAlign="Left" />
                                                                        </asp:BoundField>
                                                                        <asp:BoundField DataField="ppacc_iEstado_Registro" HeaderText="ESTADO"  Visible="False"/>
                                                                    </Columns>
                                                                </asp:GridView>
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <tr>
                                                    <td align="center" style="height: 21px">
                                                        ...
                                                        <asp:Button ID="btnRegresar" runat="server" CssClass="InputBoton" Text="Regresar" Width="80px" /></td>
                                                </tr>
                                                <tr>
